...
class ControllerAgregar {
    ...
    public function registrar() {
        ...
        $ingreso = $_POST['ingreso']; // Formato: YYYY-MM-DD
        $hora = $_POST['hora'];       // Formato: HH:MM:SS
        $entrega = $_POST['entrega']; // Formato: YYYY-MM-DD
        ...
        // Insertar turno con fecha y hora separadas
        $idTurno = $this->modelTurno->createTurno($ingreso, $entrega, $patente, $hora);
        if (!$idTurno) {
